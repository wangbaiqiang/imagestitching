...
extern "C" {
    JNIEXPORT jint JNICALL Java_com_hipad_opencvforstitchingimage_StitchingActivity_StitchPanorama(JNIEnv*, jobject, jobjectArray, jint, jlong);
    JNIEXPORT jint JNICALL Java_com_hipad_opencvforstitchingimage_StitchingActivity_StitchPanorama(JNIEnv* env, jobject, jobjectArray images, jint size, jlong resultMatAddr)
    {
        jint result = 0;
